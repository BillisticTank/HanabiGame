...
import edu.up.cs301.hanabiPack.R;
...
public class MessageBox {
    ...
    public static void popUpDeleteGame(String msg, final Activity activity) {
        ...
        builder.setItems(strings, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                Logger.log(TAG, Saving.deleteFromFile(activity.getString(R.string.Hanabi_app) + "_" + strings[whichButton].toString(), activity) + "");
                Logger.log(TAG, Saving.deleteFromFile(activity.getString(R.string.Hanabi_app) + "_" + strings[whichButton].toString() + ".c", activity) + "");
                dialog.dismiss();
                return;
            }
        });
    ...
    private static CharSequence[] getGameFileNames(Activity activity){
        ...
        String appName = activity.getString(R.string.Hanabi_app);
        for(File file: files){
